...
class Follower:
        ...
        def image_callback(self, msg):
                ...
                # mask1 = cv2.warpPerspective(mask1, hinfo, (w,h))
                # mask2 = cv2.warpPerspective(mask2, hinfo, (w,h))
                ...
                #     self.twist.angular.z = (err*90.0/160)/20
